(h3 "DESCRIPTION")
(p "Embeddable Library for Kernel-level development."
   (br)
   "ELKlib should provide basic C/C++ support (string/memory functions,
    STL-like containers and so on) for kernel developers. A sort of
    uClibc/newlib oriented to the kernel-level development."
 )
(h3 "AUTHORS")
