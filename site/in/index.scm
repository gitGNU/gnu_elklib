...
(h4 "Installation")
(p
 "ELKlib uses the autoconf/automake facilities. The simplest way to install "
...
(p
 "Use " (kbd "./configure --help") " to get a brief help of all "
...
(h4 "Use")
(p
 "To easily detect the presence of elklib in a host system, the following "
 "scripts come handy:")
...
(h3 "MAILING LISTS")
(p
 "ELKlib has a single moderated mailing list, with an archive. "
...
(p
 ...
 "a report as possible to <elklib AT nongnu DOT org>. An easy way to collect "
